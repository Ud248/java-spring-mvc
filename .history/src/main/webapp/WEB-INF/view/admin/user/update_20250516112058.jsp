                ...
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-6 col-12 mx-auto">
                            ...
                            <hr>
                            <form:form method="post" action="/admin/user/create" modelAttribute="user"></form:form>
                            <div class="mb-3">
                                <label path="id" class="form-label">Id:</label>
                                <form:input type="Text" class="form-control" path="id" aria-readonly="true" />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label path="phone" class="form-label">Phone number:</label>
